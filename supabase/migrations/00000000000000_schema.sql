...
CREATE TYPE "public"."skate_spot_surface" AS ENUM (
    'wood',
    'concrete',
    'asphalt',
    'sport_court',
...
ALTER TYPE "public"."skate_spot_surface" OWNER TO "postgres";
...
CREATE TYPE "public"."task_module" AS ENUM (
    'inventory',
    'sales',
    'work_orders',
    'cfo',
...
ALTER TYPE "public"."task_module" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."admin_add_hardware_blacklist"("p_mac_address" "text", "p_reason" "text") RETURNS "void"
...
ALTER FUNCTION "public"."admin_add_hardware_blacklist"("p_mac_address" "text", "p_reason" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."admin_ban_user"("p_target_user_id" "uuid", "p_reason" "text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."admin_ban_user"("p_target_user_id" "uuid", "p_reason" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."admin_export_user_data"("p_target_user_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."admin_export_user_data"("p_target_user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."admin_force_password_reset"("p_target_user_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."admin_force_password_reset"("p_target_user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."admin_get_global_telemetry"() RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."admin_get_global_telemetry"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."admin_remove_hardware_blacklist"("p_mac_address" "text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."admin_remove_hardware_blacklist"("p_mac_address" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."admin_revoke_admin_role"("p_target_user_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."admin_revoke_admin_role"("p_target_user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."admin_revoke_ban"("p_target_user_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."admin_revoke_ban"("p_target_user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."admin_revoke_sessions"("p_target_user_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
...
ALTER FUNCTION "public"."admin_revoke_sessions"("p_target_user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."admin_soft_delete_user"("p_target_user_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."admin_soft_delete_user"("p_target_user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."delete_group_cascade"("p_group_id" "text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
BEGIN
  -- 1. Guard: caller must be authenticated
  IF v_user_id IS NULL THEN
    RAISE EXCEPTION 'delete_group_cascade: not authenticated';
  END IF;

  -- 2. Clear group membership on all member devices (no orphan group_id references)
  ...
  -- 3. Delete the group row (RLS policy will also enforce ownership)
...
ALTER FUNCTION "public"."delete_group_cascade"("p_group_id" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."flush_telemetry"("payload" "jsonb") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
BEGIN
    v_user_id := auth.uid();
    -- Graceful no-op: if called without a valid session (anon key), silently return.
    -- Raw telemetry is already persisted in telemetry_snapshots via direct INSERT.
    -- The accumulation will succeed on the next authenticated flush cycle.
    IF v_user_id IS NULL THEN
        RETURN;
    END IF;
...
ALTER FUNCTION "public"."flush_telemetry"("payload" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_active_schema_tables"() RETURNS TABLE("table_name" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION "public"."get_active_schema_tables"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_closest_skate_spot"("p_lat" double precision, "p_lng" double precision, "p_radius_meters" double precision) RETURNS TABLE("spot_id" "uuid", "name" "text", "distance_meters" double precision)
    LANGUAGE "plpgsql"
    SET "search_path" TO 'public'
    AS $$
BEGIN
    ...
    SELECT 
        s.id,
        s.name,
        -- Haversine formula calculation (approximate meters)
        ( 6371000 * acos( 
    ...
    WHERE 
        ...
        -- Rough bounding box pre-filter for performance
        AND s.lat BETWEEN p_lat - (p_radius_meters / 111000) AND p_lat + (p_radius_meters / 111000)
        AND s.lng BETWEEN p_lng - (p_radius_meters / (111000 * cos(radians(p_lat)))) AND p_lng + (p_radius_meters / (111000 * cos(radians(p_lat))))
    ORDER BY 
        distance_meters ASC
    LIMIT 1;
END;
...
ALTER FUNCTION "public"."get_closest_skate_spot"("p_lat" double precision, "p_lng" double precision, "p_radius_meters" double precision) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_databank_coverage"() RETURNS TABLE("state" "text", "total" bigint, "published" bigint, "PENDING" bigint, "SEEDED" bigint, "ENRICHED" bigint, "DEEP_CRAWLED" bigint, "MEDIA_READY" bigint)
    LANGUAGE "sql" STABLE
    SET "search_path" TO 'public'
    AS $$
  SELECT COALESCE(s.state,'UNKNOWN'), COUNT(*),
    COUNT(*) FILTER (WHERE s.is_published=true),
    COUNT(*) FILTER (WHERE COALESCE(s.verification_status,'PENDING')='PENDING'),
    COUNT(*) FILTER (WHERE s.verification_status='SEEDED'),
    COUNT(*) FILTER (WHERE s.verification_status='ENRICHED'),
    COUNT(*) FILTER (WHERE s.verification_status='DEEP_CRAWLED'),
    COUNT(*) FILTER (WHERE s.verification_status='MEDIA_READY')
  FROM skate_spots s GROUP BY COALESCE(s.state,'UNKNOWN') ORDER BY COUNT(*) DESC;
$$;


ALTER FUNCTION "public"."get_databank_coverage"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_nearby_push_tokens"("p_session_id" "uuid", "p_max_tokens" integer DEFAULT 200) RETURNS TABLE("token" "text", "platform" "text")
    LANGUAGE "sql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  -- Exclude the session leader and existing members
  SELECT pt.token, pt.platform
  FROM public.push_tokens pt
  WHERE pt.user_id != (
    SELECT leader_user_id FROM public.crew_sessions WHERE id = p_session_id
  )
  AND pt.user_id NOT IN (
    SELECT user_id FROM public.crew_members WHERE session_id = p_session_id
  )
  LIMIT p_max_tokens;
$$;


ALTER FUNCTION "public"."get_nearby_push_tokens"("p_session_id" "uuid", "p_max_tokens" integer) OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."skate_spots" (
    ...
    "raw_knowledge_panel" "jsonb",
    "city" "text",
    "state" "text",
    "zip" "text",
    "has_proshop" boolean DEFAULT false,
    "street_address" "text",
    "opening_hours" "jsonb",
    "website" "text",
    "socials" "jsonb",
    ...
    "has_adult_night" boolean DEFAULT false,
    ...
    "cultural_metadata" "jsonb" DEFAULT '{}'::"jsonb",
    ...
    "is_deep_crawled" boolean DEFAULT false,
    "adult_night_schedule" "jsonb",
    "candidate_photos" "jsonb",
    "photos" "jsonb",
    ...
    CONSTRAINT "skate_spots_verification_status_check" CHECK (("verification_status" = ANY (ARRAY['PENDING'::"text", 'SEEDED'::"text", 'ENRICHED'::"text", 'DEEP_CRAWLED'::"text", 'MEDIA_READY'::"text", 'PUBLISHED'::"text", 'REJECTED'::"text", 'ON_HOLD'::"text", 'STALLED'::"text"])))
);


ALTER TABLE "public"."skate_spots" OWNER TO "postgres";


COMMENT ON COLUMN "public"."skate_spots"."surface_quality" IS 'Detected surface type: Buttery, Smooth, Crusty, Rough, etc.';



COMMENT ON COLUMN "public"."skate_spots"."vibe_score" IS 'Weighted sentiment score from user reviews (0-5).';



COMMENT ON COLUMN "public"."skate_spots"."adult_night_schedule" IS 'Per-day adult/18+ night schedule. Format: {"friday": "9pm-midnight", "saturday": "10pm-1am"}';



COMMENT ON COLUMN "public"."skate_spots"."email_addresses" IS 'Array of all discovered contact emails for this venue';



CREATE OR REPLACE FUNCTION "public"."get_next_spot_for_indexer"("priority_states" "text"[] DEFAULT ARRAY[]::"text"[]) RETURNS SETOF "public"."skate_spots"
    LANGUAGE "sql"
    SET "search_path" TO 'public'
    AS $$
  SELECT s.* FROM skate_spots s
  WHERE s.verification_status='ENRICHED' AND s.candidate_links IS NOT NULL
    AND (array_length(priority_states,1) IS NULL OR array_length(priority_states,1)=0 OR s.state=ANY(priority_states))
    AND s.facility_type IN ('roller_rink','skate_park','skate_shop')
  ORDER BY CASE WHEN s.facility_type='roller_rink' THEN 1 WHEN s.facility_type='skate_shop' THEN 2 WHEN s.facility_type='skate_park' THEN 3 ELSE 4 END,
    s.last_attempted_at ASC NULLS FIRST, s.id ASC LIMIT 1;
$$;


ALTER FUNCTION "public"."get_next_spot_for_indexer"("priority_states" "text"[]) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_next_spot_for_operator"("priority_states" "text"[] DEFAULT ARRAY[]::"text"[]) RETURNS SETOF "public"."skate_spots"
    LANGUAGE "sql"
    SET "search_path" TO 'public'
    AS $$
  SELECT s.* FROM skate_spots s
  WHERE s.verification_status='SEEDED' AND s.website IS NOT NULL AND s.website!=''
    AND (array_length(priority_states,1) IS NULL OR array_length(priority_states,1)=0 OR s.state=ANY(priority_states))
    AND s.facility_type IN ('roller_rink','skate_park','skate_shop')
  ORDER BY CASE WHEN s.facility_type='roller_rink' THEN 1 WHEN s.facility_type='skate_shop' THEN 2 WHEN s.facility_type='skate_park' THEN 3 ELSE 4 END,
    s.last_attempted_at ASC NULLS FIRST, s.id ASC LIMIT 1;
...
ALTER FUNCTION "public"."get_next_spot_for_operator"("priority_states" "text"[]) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."handle_auto_promotion"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."handle_auto_promotion"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."increment_scene_download"("scene_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."increment_scene_download"("scene_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."increment_scene_upvote"("scene_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."increment_scene_upvote"("scene_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."upsert_group_with_devices"("p_group_id" "text", "p_group_name" "text", "p_type" "text", "p_device_ids" "text"[]) RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."upsert_group_with_devices"("p_group_id" "text", "p_group_name" "text", "p_type" "text", "p_device_ids" "text"[]) OWNER TO "postgres";
...
COMMENT ON TABLE "public"."app_settings" IS 'app settings save state';
...
CREATE TABLE IF NOT EXISTS "public"."crew_memberships" (
    ...
    CONSTRAINT "crew_memberships_role_check" CHECK (("role" = ANY (ARRAY['owner'::"text", 'member'::"text"])))
);


ALTER TABLE "public"."crew_memberships" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."crew_sessions" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "invite_code" "text" DEFAULT "upper"("substring"("replace"(("gen_random_uuid"())::"text", '-'::"text", ''::"text"), 1, 6)) NOT NULL,
    "name" "text" DEFAULT 'Crew Session'::"text" NOT NULL,
    "leader_user_id" "uuid",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    ...
    "top_speed_mph" numeric DEFAULT 0,
    "avg_speed_mph" numeric DEFAULT 0,
    "total_distance_miles" numeric DEFAULT 0,
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "crew_sessions_status_check" CHECK (("status" = ANY (ARRAY['scheduled'::"text", 'active'::"text", 'ended'::"text"])))
);


ALTER TABLE "public"."crew_sessions" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."crews" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "is_public" boolean DEFAULT false NOT NULL,
    "avatar_color" "text" DEFAULT '#FFAA00'::"text",
    "avatar_icon" "text" DEFAULT 'account-group'::"text",
    "avatar_url" "text",
    "city" "text",
    "state" "text",
    "description" "text",
...
COMMENT ON COLUMN "public"."crews"."is_public" IS 'true = anyone can find and request to join without an invite code';



COMMENT ON COLUMN "public"."crews"."avatar_color" IS 'Crew avatar background color hex';



COMMENT ON COLUMN "public"."crews"."avatar_icon" IS 'MaterialCommunityIcons name for crew avatar icon';



COMMENT ON COLUMN "public"."crews"."avatar_url" IS 'Optional uploaded photo URL from expo-image-picker';



COMMENT ON COLUMN "public"."crews"."city" IS 'Optional crew home city for discovery';



COMMENT ON COLUMN "public"."crews"."state" IS 'Optional crew home state/region for discovery';



CREATE TABLE IF NOT EXISTS "public"."custom_builder_presets" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "user_id" "uuid",
    "name" "text" NOT NULL,
...
ALTER TABLE "public"."custom_builder_presets" OWNER TO "postgres";
...
ALTER TABLE "public"."cyclez" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."daemon_status" (
    ...
    "total_denials" integer DEFAULT 0 NOT NULL,
    "last_heartbeat" timestamp with time zone,
    "last_error" "text",
    CONSTRAINT "single_row_enforcer" CHECK (("id" = '00000000-0000-0000-0000-000000000000'::"uuid"))
);


ALTER TABLE "public"."daemon_status" OWNER TO "postgres";
...
ALTER TABLE "public"."device_group_members" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."discovered_devices_telemetry" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    ...
    "ble_version" smallint,
    "product_id" smallint,
    "led_version" smallint,
...
ALTER TABLE "public"."discovered_devices_telemetry" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."full_landed_costs" (
    "id" integer NOT NULL,
    "parcel_no" "text",
    "di_item_id" "text",
    "item_name" "text",
    "specification" "text",
    "quantity" integer,
    "total_dist_weight_g" double precision,
    "unit_weight_g" double precision,
    "order_date" "text",
    "order_no" "text",
    "alibaba_order" "text",
    "order_unit_price" numeric,
    "order_postage" numeric,
    "order_total" numeric,
    "unit_china_landed_price" numeric,
    "actual_paid" numeric,
    "actual_chargeable_weight_g" numeric,
    "actual_shipping_fee" numeric,
    "first_tier_cost" numeric,
    "second_tier_cost" numeric,
    "custom_clearance_fee" numeric,
    "remote_area_surcharge" numeric,
    "fuel_surcharge" numeric,
    "operating_cost" numeric,
    "tax" numeric,
    "insurance" numeric,
    "storage_fee" numeric,
    "epe_loose_filling" numeric,
    "corner_protector" numeric,
    "moister_barrier_bag" numeric,
    "packing_video" numeric,
    "one_percent_discount" numeric,
    "points_discount" numeric,
    "coupon_discount" numeric,
    "discount_code" numeric,
    "unit_ship_weight" numeric,
    "final_cost_weight" numeric,
    "total_cost_weight" numeric,
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    "neogleamz_name" "text",
    "neogleamz_product" "text",
    "lot_multiplier" double precision DEFAULT '1'::double precision,
    "is_3d_print" boolean DEFAULT false,
    "print_time_mins" numeric DEFAULT 0,
    "is_filament" boolean DEFAULT false,
    "print_grams" numeric DEFAULT 0,
    "item_uuid" "uuid" DEFAULT "gen_random_uuid"() NOT NULL
);


ALTER TABLE "public"."full_landed_costs" OWNER TO "postgres";


COMMENT ON COLUMN "public"."full_landed_costs"."lot_multiplier" IS 'Lot multiplier for 1000s';



CREATE SEQUENCE IF NOT EXISTS "public"."full_landed_costs_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE "public"."full_landed_costs_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "public"."full_landed_costs_id_seq" OWNED BY "public"."full_landed_costs"."id";
...
ALTER TABLE "public"."hardware_blacklist" OWNER TO "postgres";
...
ALTER TABLE "public"."inventory_adjustments_log" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."inventory_consumption" (
    "consumed_qty" numeric DEFAULT 0,
    "manual_adjustment" numeric DEFAULT 0,
    "produced_qty" double precision DEFAULT '0'::double precision,
    "sold_qty" double precision DEFAULT '0'::double precision,
    "min_stock" double precision DEFAULT '0'::double precision,
    "scrap_qty" numeric DEFAULT '0'::numeric,
    "prototype_consumed_qty" numeric DEFAULT 0,
    "assembly_consumed_qty" numeric DEFAULT 0,
    "production_consumed_qty" numeric DEFAULT 0,
    "prototype_produced_qty" numeric DEFAULT 0,
    "rop_lead_time_days" numeric DEFAULT 5,
...
CREATE TABLE IF NOT EXISTS "public"."label_designs" (
    ...
    "file_name" "text",
    "layout_json" "jsonb",
    "label_size" "text" DEFAULT '2.25x1.25'::"text",
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    "product_item_uuid" "uuid"
);


ALTER TABLE "public"."label_designs" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."led_diagnostics" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "user_id" "uuid",
...
ALTER TABLE "public"."led_diagnostics" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."pack_ship_sops" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "instruction_json" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "required_box_sku" "text",
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    "updated_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    "recipe_item_uuid" "uuid" NOT NULL
);


ALTER TABLE "public"."pack_ship_sops" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."parsed_session_stats" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "session_id" "text",
    "device_id" "text",
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()) NOT NULL,
    ...
    "storage_bytes_estimate" integer,
    "average_load_time_ms" integer,
    "battery_level" numeric,
    "is_low_power_mode" boolean,
    "group_id" "text",
    "group_name" "text",
    "total_storage_estimate" bigint DEFAULT 0,
    "last_app_opened_time" bigint DEFAULT 0,
    "primary_ble_mac" "text",
    "mode_usage" "jsonb" DEFAULT '{}'::"jsonb",
    ...
    "battery_state" "text",
    "host_device_info" "jsonb" DEFAULT '{}'::"jsonb"
);


ALTER TABLE "public"."parsed_session_stats" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."product_catalog" (
    ...
    "default_led_points" integer NOT NULL,
    "default_segments" integer DEFAULT 1 NOT NULL,
    "default_ic_type" integer DEFAULT 1 NOT NULL,
    "default_color_sorting" integer DEFAULT 2 NOT NULL,
    "detect_min_points" integer NOT NULL,
    "detect_max_points" integer NOT NULL,
    "viz_shape" "text" DEFAULT 'OVAL'::"text" NOT NULL,
    "viz_default_points" integer NOT NULL,
    "viz_blob_diameter_mm" double precision DEFAULT 5.7 NOT NULL,
    "viz_base_width" integer DEFAULT 55 NOT NULL,
    "viz_base_height" integer DEFAULT 115 NOT NULL,
    "viz_strip_count" integer,
    "viz_strip_separation" double precision,
    "viz_strip_orientation" "text",
    "is_active" boolean DEFAULT true NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "product_catalog_viz_shape_check" CHECK (("viz_shape" = ANY (ARRAY['RING'::"text", 'OVAL'::"text", 'DUAL_STRIP'::"text"]))),
    CONSTRAINT "product_catalog_viz_strip_orientation_check" CHECK (("viz_strip_orientation" = ANY (ARRAY['HORIZONTAL'::"text", 'VERTICAL'::"text", NULL::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."product_recipes" (
    ...
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()),
    "labor_time_mins" double precision DEFAULT '0'::double precision,
    "labor_rate_hr" double precision DEFAULT '0'::double precision,
    "msrp" numeric DEFAULT '0'::numeric,
    "wholesale_price" numeric DEFAULT '0'::numeric,
    "is_subassembly" boolean DEFAULT false,
    "old_msrp" numeric DEFAULT '0'::numeric,
    "affiliate_pct" numeric DEFAULT '0'::numeric,
    "warranty_pct" numeric DEFAULT '0'::numeric,
    "is_3d_print" boolean DEFAULT false,
    "print_time_mins" numeric DEFAULT 0,
    "print_grams" numeric DEFAULT 0,
    "is_label" boolean DEFAULT false,
    "label_emoji" "text" DEFAULT '🏷️'::"text",
    "filament_item_uuid" "uuid",
...
CREATE TABLE IF NOT EXISTS "public"."production_sops" (
    "steps" "jsonb",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "product_item_uuid" "uuid" NOT NULL
);
...
ALTER TABLE "public"."production_sops" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."projectz" (
    ...
    "title" "text" NOT NULL,
    "description" "text",
    "visibility" "public"."project_visibility" DEFAULT 'Organization'::"public"."project_visibility",
    "health_status" "public"."project_status" DEFAULT 'On Track'::"public"."project_status",
...
ALTER TABLE "public"."projectz" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."user_profiles" (
    "user_id" "uuid" NOT NULL,
    "display_name" "text",
    "avatar_color" "text" DEFAULT '#FF8C00'::"text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "username" "text",
    "avatar_url" "text",
    "lifetime_top_speed_mph" numeric DEFAULT 0,
    "lifetime_distance_miles" numeric DEFAULT 0,
    "accepted_eula_version" integer DEFAULT 0,
...
CREATE OR REPLACE VIEW "public"."public_sessions" WITH ("security_invoker"='true') AS
 SELECT "cs"."id",
    "cs"."name",
    "cs"."invite_code",
    "cs"."location_label",
    ...
    "up"."username" AS "leader_username",
    "cr"."name" AS "crew_name",
    ( SELECT "count"(*) AS "count"
           FROM "public"."crew_members" "cm"
          WHERE ("cm"."session_id" = "cs"."id")) AS "member_count"
   FROM (("public"."crew_sessions" "cs"
     LEFT JOIN "public"."user_profiles" "up" ON (("up"."user_id" = "cs"."leader_user_id")))
     LEFT JOIN "public"."crews" "cr" ON (("cr"."id" = "cs"."crew_id")))
  WHERE (("cs"."is_public" = true) AND ("cs"."is_active" = true) AND (("cs"."status" IS NULL) OR ("cs"."status" <> 'ended'::"text")));


ALTER VIEW "public"."public_sessions" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."raw_orders" (
    ...
    "order_total" numeric,
    "unit_china_landed_price" numeric,
    "makeup_fee" numeric DEFAULT 0,
    CONSTRAINT "enforce_di_length" CHECK ((("char_length"("di_item_id") = 13) AND ("di_item_id" ~~ 'DI%'::"text")))
);
...
CREATE TABLE IF NOT EXISTS "public"."raw_parcel_items" (
    "id" integer NOT NULL,
    "parcel_no" "text",
    "di_item_id" "text",
    "item_name" "text",
    "specification" "text",
    "quantity" integer,
    "total_dist_weight_g" numeric,
    "unit_weight_g" numeric,
    CONSTRAINT "enforce_di_length" CHECK ((("char_length"("di_item_id") = 13) AND ("di_item_id" ~~ 'DI%'::"text")))
);


ALTER TABLE "public"."raw_parcel_items" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "public"."raw_parcel_items_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE "public"."raw_parcel_items_id_seq" OWNER TO "postgres";


ALTER SEQUENCE "public"."raw_parcel_items_id_seq" OWNED BY "public"."raw_parcel_items"."id";



CREATE TABLE IF NOT EXISTS "public"."raw_parcel_summary" (
...
ALTER TABLE "public"."raw_parcel_summary" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."registered_devices" (
    ...
    "manufacturer_data" "text",
    "ble_version" integer,
    "rf_mode" "text" DEFAULT 'ALLOW_ALL'::"text",
    "rf_paired_count" smallint DEFAULT 0,
    "product_id_confirmed_at" timestamp with time zone,
    CONSTRAINT "registered_devices_position_check" CHECK (("position" = ANY (ARRAY['Left'::"text", 'Right'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."registered_groups" (
    "id" "text" NOT NULL,
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."registered_groups" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."sales_ledger" (
    ...
    "sale_date" "date",
    "storefront_sku" "text",
    "qty_sold" numeric DEFAULT '0'::numeric,
    "actual_sale_price" numeric DEFAULT '0'::numeric,
    "cogs_at_sale" numeric DEFAULT '0'::numeric,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "shipping" numeric,
    "taxes" numeric,
    ...
    "exchange_value" numeric(10,2) DEFAULT 0.00,
    "linked_order_id" "text",
    "transaction_fees" numeric(10,2) DEFAULT 0.00,
    "net_profit" numeric(10,2),
    "internal_fulfillment_status" "text" DEFAULT 'Awaiting Assembly'::"text",
    "qa_cleared_at" timestamp with time zone,
    "assembly_completed_at" timestamp with time zone,
    "financial_status" character varying,
    "fulfillment_status" character varying,
    "lineitem_compare_at_price" numeric DEFAULT 0,
    "lineitem_fulfillment_status" character varying,
    "tags" "text",
    ...
    "shipping_name_hash" "text",
    "shipping_address_hash" "text",
    "isFirstRow" boolean DEFAULT false,
...
ALTER TABLE "public"."sales_ledger" OWNER TO "postgres";
...
ALTER TABLE "public"."shared_scenes" OWNER TO "postgres";
...
ALTER TABLE "public"."shopify_webhook_logs" OWNER TO "postgres";
...
ALTER TABLE "public"."sk8lytz_app_settings" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."sk8lytz_picks" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    ...
    "brightness" integer DEFAULT 90 NOT NULL,
    "fixed_color_mode" "text",
    "fixed_fg_color" "text",
    "fixed_bg_color" "text",
    "fixed_hue" integer,
    "multi_colors" "jsonb",
    "multi_transition" integer,
    "multi_length" integer,
    "music_primary_color" "text",
    "music_secondary_color" "text",
    "mic_sensitivity" integer,
    "mic_source" "text",
    "music_matrix_style" integer,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "active_from" "date",
    "active_until" "date",
...
ALTER TABLE "public"."sk8lytz_picks" OWNER TO "postgres";
...
ALTER TABLE "public"."skate_sessions" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."socialz_audience" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "region" "text",
    "location" "text",
    ...
    "link_yt" "text",
    "link_fb" "text",
    "followers_ig" numeric DEFAULT 0,
    "followers_tt" numeric DEFAULT 0,
    "followers_yt" numeric DEFAULT 0,
    "followers_fb" numeric DEFAULT 0,
    "raw_followers" numeric DEFAULT 0,
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()) NOT NULL,
...
ALTER TABLE "public"."socialz_audience" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."sop_archives" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "order_id" "text" NOT NULL,
    "internal_recipe_name" "text" NOT NULL,
    "qa_passed_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "packer_telemetry" "jsonb",
    "sop_snapshot" "jsonb",
    "required_box_sku" "text"
);


ALTER TABLE "public"."sop_archives" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."storefront_aliases" (
    "product_sku" "text" NOT NULL,
    "platform" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "barcode_value" "text",
    "is_shopify_synced" boolean DEFAULT false,
...
ALTER TABLE "public"."storefront_aliases" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."tagz" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "name" "text" NOT NULL,
    "color_hex" "text" DEFAULT '#64748b'::"text",
    "created_at" timestamp with time zone DEFAULT "now"()
);


ALTER TABLE "public"."tagz" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."task_templates" (
    ...
    "title" "text" NOT NULL,
    "description" "text",
    "default_status" "public"."task_status" DEFAULT 'Todo'::"public"."task_status",
...
CREATE TABLE IF NOT EXISTS "public"."taskz" (
    ...
    "parent_task_id" "uuid",
    "cycle_id" "uuid",
    "linked_module" "public"."task_module" DEFAULT 'general'::"public"."task_module",
    ...
    "is_archived" boolean DEFAULT false,
    "project_id" "uuid",
    "personal_cycle_id" "uuid"
);


ALTER TABLE "public"."taskz" OWNER TO "postgres";
...
ALTER TABLE "public"."telemetry_errors" OWNER TO "postgres";
...
ALTER TABLE "public"."telemetry_snapshots" OWNER TO "postgres";
...
ALTER TABLE "public"."template_subtasks" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."tipz" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()) NOT NULL,
    "user_email" "text",
...
ALTER TABLE "public"."tipz" OWNER TO "postgres";


ALTER TABLE "public"."tipz" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."tipz_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."user_lifetime_stats" (
    "user_id" "uuid" NOT NULL,
    "total_app_time_sec" integer DEFAULT 0,
    "total_distance_meters" double precision DEFAULT 0.0,
    "lifetime_top_speed_mph" double precision DEFAULT 0.0,
    "total_street_sessions" integer DEFAULT 0,
...
ALTER TABLE "public"."user_lifetime_stats" OWNER TO "postgres";
...
ALTER TABLE "public"."user_saved_presets" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."full_landed_costs" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."full_landed_costs_id_seq"'::"regclass");



ALTER TABLE ONLY "public"."raw_parcel_items" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."raw_parcel_items_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."crew_members"
    ADD CONSTRAINT "crew_members_session_id_user_id_key" UNIQUE ("session_id", "user_id");



ALTER TABLE ONLY "public"."crew_memberships"
    ADD CONSTRAINT "crew_memberships_crew_id_user_id_key" UNIQUE ("crew_id", "user_id");



ALTER TABLE ONLY "public"."crew_memberships"
    ADD CONSTRAINT "crew_memberships_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."crew_sessions"
    ADD CONSTRAINT "crew_sessions_invite_code_key" UNIQUE ("invite_code");
...
ALTER TABLE ONLY "public"."custom_builder_presets"
    ADD CONSTRAINT "custom_builder_presets_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."cyclez"
    ADD CONSTRAINT "cyclez_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."daemon_status"
    ADD CONSTRAINT "daemon_status_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."device_group_members"
    ADD CONSTRAINT "device_group_members_pkey" PRIMARY KEY ("device_id", "group_id");



ALTER TABLE ONLY "public"."discovered_devices_telemetry"
    ADD CONSTRAINT "discovered_devices_telemetry_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."feature_flags"
    ADD CONSTRAINT "feature_flags_flag_key_target_user_id_key" UNIQUE ("flag_key", "target_user_id");
...
ALTER TABLE ONLY "public"."full_landed_costs"
    ADD CONSTRAINT "full_landed_costs_item_uuid_key" UNIQUE ("item_uuid");



ALTER TABLE ONLY "public"."full_landed_costs"
    ADD CONSTRAINT "full_landed_costs_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."hardware_blacklist"
    ADD CONSTRAINT "hardware_blacklist_pkey" PRIMARY KEY ("mac_address");



ALTER TABLE ONLY "public"."inventory_adjustments_log"
    ADD CONSTRAINT "inventory_adjustments_log_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."inventory_consumption"
    ADD CONSTRAINT "inventory_consumption_pkey" PRIMARY KEY ("item_uuid");
...
ALTER TABLE ONLY "public"."led_diagnostics"
    ADD CONSTRAINT "led_diagnostics_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."pack_ship_sops"
    ADD CONSTRAINT "pack_ship_sops_pkey" PRIMARY KEY ("recipe_item_uuid");



ALTER TABLE ONLY "public"."parsed_session_stats"
    ADD CONSTRAINT "parsed_session_stats_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."product_recipes"
    ADD CONSTRAINT "product_recipes_pkey" PRIMARY KEY ("product_item_uuid");



ALTER TABLE ONLY "public"."production_sops"
    ADD CONSTRAINT "production_sops_pkey" PRIMARY KEY ("product_item_uuid");



ALTER TABLE ONLY "public"."projectz"
    ADD CONSTRAINT "projectz_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."raw_orders"
    ADD CONSTRAINT "raw_orders_pkey" PRIMARY KEY ("di_item_id");



ALTER TABLE ONLY "public"."raw_parcel_items"
    ADD CONSTRAINT "raw_parcel_items_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."raw_parcel_summary"
    ADD CONSTRAINT "raw_parcel_summary_pkey" PRIMARY KEY ("parcel_no");
...
ALTER TABLE ONLY "public"."registered_devices"
    ADD CONSTRAINT "registered_devices_user_id_device_mac_key" UNIQUE ("user_id", "device_mac");
...
ALTER TABLE ONLY "public"."registered_groups"
    ADD CONSTRAINT "registered_groups_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."shared_scenes"
    ADD CONSTRAINT "shared_scenes_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."shopify_webhook_logs"
    ADD CONSTRAINT "shopify_webhook_logs_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."shopify_webhook_logs"
    ADD CONSTRAINT "shopify_webhook_logs_shopify_event_id_key" UNIQUE ("shopify_event_id");



ALTER TABLE ONLY "public"."sk8lytz_app_settings"
    ADD CONSTRAINT "sk8lytz_app_settings_pkey" PRIMARY KEY ("setting_key");



ALTER TABLE ONLY "public"."sk8lytz_picks"
    ADD CONSTRAINT "sk8lytz_picks_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."skate_sessions"
    ADD CONSTRAINT "skate_sessions_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."skate_spots"
    ADD CONSTRAINT "skate_spots_google_place_id_key" UNIQUE ("google_place_id");



ALTER TABLE ONLY "public"."skate_spots"
    ADD CONSTRAINT "skate_spots_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."socialz_audience"
    ADD CONSTRAINT "socialz_audience_name_key" UNIQUE ("name");



ALTER TABLE ONLY "public"."socialz_audience"
    ADD CONSTRAINT "socialz_audience_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."sop_archives"
    ADD CONSTRAINT "sop_archives_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."storefront_aliases"
    ADD CONSTRAINT "storefront_aliases_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."storefront_aliases"
    ADD CONSTRAINT "storefront_aliases_shopify_sku_key" UNIQUE ("shopify_sku");



ALTER TABLE ONLY "public"."tagz"
    ADD CONSTRAINT "tagz_name_key" UNIQUE ("name");



ALTER TABLE ONLY "public"."tagz"
    ADD CONSTRAINT "tagz_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."task_dependencies"
    ADD CONSTRAINT "task_dependencies_pkey" PRIMARY KEY ("task_id", "blocked_by_id");
...
ALTER TABLE ONLY "public"."taskz"
    ADD CONSTRAINT "taskz_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."template_subtasks"
    ADD CONSTRAINT "template_subtasks_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."tipz"
    ADD CONSTRAINT "tipz_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."full_landed_costs"
    ADD CONSTRAINT "unique_parcel_item" UNIQUE ("parcel_no", "di_item_id");



ALTER TABLE ONLY "public"."raw_parcel_items"
    ADD CONSTRAINT "unique_raw_parcel_item" UNIQUE ("parcel_no", "di_item_id");



ALTER TABLE ONLY "public"."parsed_session_stats"
    ADD CONSTRAINT "unique_session_stats" UNIQUE ("session_id");



ALTER TABLE ONLY "public"."user_lifetime_stats"
    ADD CONSTRAINT "user_lifetime_stats_pkey" PRIMARY KEY ("user_id");
...
CREATE INDEX "crew_members_user_id_idx" ON "public"."crew_members" USING "btree" ("user_id");



CREATE INDEX "crew_memberships_user_id_idx" ON "public"."crew_memberships" USING "btree" ("user_id");



CREATE INDEX "crew_sessions_leader_id_idx" ON "public"."crew_sessions" USING "btree" ("leader_user_id");



CREATE INDEX "crews_owner_id_idx" ON "public"."crews" USING "btree" ("owner_id");



CREATE INDEX "custom_builder_presets_user_id_idx" ON "public"."custom_builder_presets" USING "btree" ("user_id");



CREATE INDEX "idx_crew_members_session_id" ON "public"."crew_members" USING "btree" ("session_id");



CREATE INDEX "idx_crew_memberships_crew_id" ON "public"."crew_memberships" USING "btree" ("crew_id");



CREATE INDEX "idx_crew_sessions_active" ON "public"."crew_sessions" USING "btree" ("is_active", "expires_at" DESC);



CREATE INDEX "idx_crew_sessions_crew_id" ON "public"."crew_sessions" USING "btree" ("crew_id");



CREATE INDEX "idx_crew_sessions_public_active" ON "public"."crew_sessions" USING "btree" ("is_public", "is_active", "created_at" DESC) WHERE (("is_public" = true) AND ("is_active" = true));



CREATE INDEX "idx_crew_sessions_scheduled" ON "public"."crew_sessions" USING "btree" ("status", "scheduled_at") WHERE ("status" = 'scheduled'::"text");



CREATE INDEX "idx_crews_is_public" ON "public"."crews" USING "btree" ("is_public") WHERE ("is_public" = true);



CREATE INDEX "idx_discovered_telemetry_location" ON "public"."discovered_devices_telemetry" USING "gist" ("location");



CREATE INDEX "idx_discovered_telemetry_mac" ON "public"."discovered_devices_telemetry" USING "btree" ("device_mac");



CREATE INDEX "idx_inventory_snapshots_created_at" ON "public"."inventory_snapshots" USING "btree" ("created_at" DESC);



CREATE INDEX "idx_parsed_session_stats_session_id" ON "public"."parsed_session_stats" USING "btree" ("session_id");



CREATE INDEX "idx_parsed_stats_created_at" ON "public"."parsed_session_stats" USING "btree" ("created_at" DESC);
...
CREATE INDEX "idx_print_queue_wo_id" ON "public"."print_queue" USING "btree" ("wo_id");
...
CREATE INDEX "idx_sales_date" ON "public"."sales_ledger" USING "btree" ("sale_date");



CREATE INDEX "idx_sales_ledger_net" ON "public"."sales_ledger" USING "btree" ("net_profit");



CREATE INDEX "idx_sales_ledger_type" ON "public"."sales_ledger" USING "btree" ("transaction_type");



CREATE INDEX "idx_sales_order_id" ON "public"."sales_ledger" USING "btree" ("order_id");



CREATE INDEX "idx_sales_storefront_sku" ON "public"."sales_ledger" USING "btree" ("storefront_sku");



CREATE INDEX "idx_sk8lytz_picks_schedule" ON "public"."sk8lytz_picks" USING "btree" ("is_active", "active_from", "active_until");



CREATE INDEX "idx_sk8lytz_picks_sort" ON "public"."sk8lytz_picks" USING "btree" ("sort_order");



CREATE INDEX "idx_skate_sessions_crew_session_id" ON "public"."skate_sessions" USING "btree" ("crew_session_id");



CREATE INDEX "idx_skate_sessions_user_id" ON "public"."skate_sessions" USING "btree" ("user_id", "session_date" DESC);



CREATE INDEX "idx_skate_spots_business_status" ON "public"."skate_spots" USING "btree" ("business_status");



CREATE INDEX "idx_skate_spots_google_place_id" ON "public"."skate_spots" USING "btree" ("google_place_id") WHERE ("google_place_id" IS NOT NULL);



CREATE INDEX "idx_skate_spots_is_published" ON "public"."skate_spots" USING "btree" ("is_published") WHERE ("is_published" = true);



CREATE INDEX "idx_skate_spots_updated_by" ON "public"."skate_spots" USING "btree" ("updated_by");



CREATE INDEX "idx_taskz_personal_cycle_id" ON "public"."taskz" USING "btree" ("personal_cycle_id");



CREATE INDEX "idx_telemetry_snapshots_metadata" ON "public"."telemetry_snapshots" USING "gin" ("metadata");



CREATE INDEX "idx_user_profiles_username" ON "public"."user_profiles" USING "btree" ("lower"("username"));



CREATE INDEX "idx_work_orders_completed_at" ON "public"."work_orders" USING "btree" ("completed_at");



CREATE INDEX "idx_work_orders_started_at" ON "public"."work_orders" USING "btree" ("started_at");



CREATE INDEX "led_diagnostics_created_at_idx" ON "public"."led_diagnostics" USING "btree" ("created_at" DESC);



CREATE INDEX "led_diagnostics_protocol_idx" ON "public"."led_diagnostics" USING "btree" ("protocol");



CREATE INDEX "led_diagnostics_user_id_idx" ON "public"."led_diagnostics" USING "btree" ("user_id");



CREATE INDEX "registered_devices_group_id_idx" ON "public"."registered_devices" USING "btree" ("group_id");



CREATE INDEX "registered_groups_user_id_idx" ON "public"."registered_groups" USING "btree" ("user_id");



CREATE INDEX "shared_scenes_author_id_idx" ON "public"."shared_scenes" USING "btree" ("author_id");



CREATE INDEX "skate_spots_name_idx" ON "public"."skate_spots" USING "btree" ("name");



CREATE UNIQUE INDEX "unique_user_device_mac_idx" ON "public"."registered_devices" USING "btree" ("user_id", "upper"("device_mac"));



CREATE OR REPLACE TRIGGER "set_crew_sessions_updated_at" BEFORE UPDATE ON "public"."crew_sessions" FOR EACH ROW EXECUTE FUNCTION "public"."set_current_timestamp_updated_at"();



CREATE OR REPLACE TRIGGER "set_crews_updated_at" BEFORE UPDATE ON "public"."crews" FOR EACH ROW EXECUTE FUNCTION "public"."set_current_timestamp_updated_at"();



CREATE OR REPLACE TRIGGER "set_registered_devices_updated_at" BEFORE UPDATE ON "public"."registered_devices" FOR EACH ROW EXECUTE FUNCTION "public"."set_current_timestamp_updated_at"();



CREATE OR REPLACE TRIGGER "set_skate_sessions_updated_at" BEFORE UPDATE ON "public"."skate_sessions" FOR EACH ROW EXECUTE FUNCTION "public"."set_current_timestamp_updated_at"();



CREATE OR REPLACE TRIGGER "set_timestamp_crew_sessions" BEFORE UPDATE ON "public"."crew_sessions" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_set_timestamp"();



CREATE OR REPLACE TRIGGER "set_timestamp_crews" BEFORE UPDATE ON "public"."crews" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_set_timestamp"();



CREATE OR REPLACE TRIGGER "set_timestamp_registered_devices" BEFORE UPDATE ON "public"."registered_devices" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_set_timestamp"();



CREATE OR REPLACE TRIGGER "trg_sk8lytz_app_settings_updated_at" BEFORE UPDATE ON "public"."sk8lytz_app_settings" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
ALTER TABLE ONLY "public"."admin_audit_logs"
    ADD CONSTRAINT "admin_audit_logs_target_user_id_fkey" FOREIGN KEY ("target_user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."crew_members"
    ADD CONSTRAINT "crew_members_session_id_fkey" FOREIGN KEY ("session_id") REFERENCES "public"."crew_sessions"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."crew_memberships"
    ADD CONSTRAINT "crew_memberships_crew_id_fkey" FOREIGN KEY ("crew_id") REFERENCES "public"."crews"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."crew_memberships"
    ADD CONSTRAINT "crew_memberships_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."user_profiles"("user_id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."crew_sessions"
    ADD CONSTRAINT "crew_sessions_crew_id_fkey" FOREIGN KEY ("crew_id") REFERENCES "public"."crews"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."crew_sessions"
    ADD CONSTRAINT "crew_sessions_leader_user_id_fkey" FOREIGN KEY ("leader_user_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."crews"
    ADD CONSTRAINT "crews_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."custom_builder_presets"
    ADD CONSTRAINT "custom_builder_presets_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."cyclez"
    ADD CONSTRAINT "cyclez_assigned_team_id_fkey" FOREIGN KEY ("assigned_team_id") REFERENCES "public"."teams"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."cyclez"
    ADD CONSTRAINT "cyclez_assigned_to_id_fkey" FOREIGN KEY ("assigned_to_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."cyclez"
    ADD CONSTRAINT "cyclez_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "public"."projectz"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."device_group_members"
    ADD CONSTRAINT "device_group_members_device_id_fkey" FOREIGN KEY ("device_id") REFERENCES "public"."registered_devices"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."device_group_members"
    ADD CONSTRAINT "device_group_members_group_id_fkey" FOREIGN KEY ("group_id") REFERENCES "public"."registered_groups"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."feature_flags"
    ADD CONSTRAINT "feature_flags_target_user_id_fkey" FOREIGN KEY ("target_user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."inventory_adjustments_log"
    ADD CONSTRAINT "fk_inv_adj_item" FOREIGN KEY ("item_uuid") REFERENCES "public"."full_landed_costs"("item_uuid") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."inventory_consumption"
    ADD CONSTRAINT "fk_inv_consumption_item" FOREIGN KEY ("item_uuid") REFERENCES "public"."full_landed_costs"("item_uuid") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."label_designs"
    ADD CONSTRAINT "fk_label_product" FOREIGN KEY ("product_item_uuid") REFERENCES "public"."full_landed_costs"("item_uuid") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."pack_ship_sops"
    ADD CONSTRAINT "fk_pack_sop_recipe" FOREIGN KEY ("recipe_item_uuid") REFERENCES "public"."full_landed_costs"("item_uuid") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."print_queue"
    ADD CONSTRAINT "fk_pq_part" FOREIGN KEY ("part_item_uuid") REFERENCES "public"."full_landed_costs"("item_uuid") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."production_sops"
    ADD CONSTRAINT "fk_prod_sop_product" FOREIGN KEY ("product_item_uuid") REFERENCES "public"."full_landed_costs"("item_uuid") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."product_recipes"
    ADD CONSTRAINT "fk_recipes_filament" FOREIGN KEY ("filament_item_uuid") REFERENCES "public"."full_landed_costs"("item_uuid") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."product_recipes"
    ADD CONSTRAINT "fk_recipes_product" FOREIGN KEY ("product_item_uuid") REFERENCES "public"."full_landed_costs"("item_uuid") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."storefront_aliases"
    ADD CONSTRAINT "fk_sa_recipe" FOREIGN KEY ("recipe_item_uuid") REFERENCES "public"."full_landed_costs"("item_uuid") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."sales_ledger"
    ADD CONSTRAINT "fk_sl_recipe" FOREIGN KEY ("recipe_item_uuid") REFERENCES "public"."full_landed_costs"("item_uuid") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."work_orders"
    ADD CONSTRAINT "fk_wo_product" FOREIGN KEY ("product_item_uuid") REFERENCES "public"."full_landed_costs"("item_uuid") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."hardware_blacklist"
    ADD CONSTRAINT "hardware_blacklist_added_by_fkey" FOREIGN KEY ("added_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."led_diagnostics"
    ADD CONSTRAINT "led_diagnostics_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."projectz"
    ADD CONSTRAINT "projectz_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."projectz"
    ADD CONSTRAINT "projectz_team_id_fkey" FOREIGN KEY ("team_id") REFERENCES "public"."teams"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."registered_devices"
    ADD CONSTRAINT "registered_devices_group_id_fkey" FOREIGN KEY ("group_id") REFERENCES "public"."registered_groups"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."registered_groups"
    ADD CONSTRAINT "registered_groups_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."shared_scenes"
    ADD CONSTRAINT "shared_scenes_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."skate_sessions"
    ADD CONSTRAINT "skate_sessions_crew_session_id_fkey" FOREIGN KEY ("crew_session_id") REFERENCES "public"."crew_sessions"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."skate_sessions"
    ADD CONSTRAINT "skate_sessions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."skate_spots"
    ADD CONSTRAINT "skate_spots_updated_by_fkey" FOREIGN KEY ("updated_by") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."task_activity"
    ADD CONSTRAINT "task_activity_task_id_fkey" FOREIGN KEY ("task_id") REFERENCES "public"."taskz"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."task_comments"
    ADD CONSTRAINT "task_comments_task_id_fkey" FOREIGN KEY ("task_id") REFERENCES "public"."taskz"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."task_dependencies"
    ADD CONSTRAINT "task_dependencies_blocked_by_id_fkey" FOREIGN KEY ("blocked_by_id") REFERENCES "public"."taskz"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."task_dependencies"
    ADD CONSTRAINT "task_dependencies_task_id_fkey" FOREIGN KEY ("task_id") REFERENCES "public"."taskz"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."taskz"
    ADD CONSTRAINT "taskz_assigned_team_id_fkey" FOREIGN KEY ("assigned_team_id") REFERENCES "public"."teams"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."taskz"
    ADD CONSTRAINT "taskz_assigned_to_id_fkey" FOREIGN KEY ("assigned_to_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."taskz"
    ADD CONSTRAINT "taskz_created_by_id_fkey" FOREIGN KEY ("created_by_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."taskz"
    ADD CONSTRAINT "taskz_cycle_id_fkey" FOREIGN KEY ("cycle_id") REFERENCES "public"."cyclez"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."taskz"
    ADD CONSTRAINT "taskz_parent_task_id_fkey" FOREIGN KEY ("parent_task_id") REFERENCES "public"."taskz"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."taskz"
    ADD CONSTRAINT "taskz_personal_cycle_id_fkey" FOREIGN KEY ("personal_cycle_id") REFERENCES "public"."cyclez"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."taskz"
    ADD CONSTRAINT "taskz_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "public"."projectz"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."template_subtasks"
    ADD CONSTRAINT "template_subtasks_template_id_fkey" FOREIGN KEY ("template_id") REFERENCES "public"."task_templates"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."user_lifetime_stats"
    ADD CONSTRAINT "user_lifetime_stats_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."user_saved_presets"
    ADD CONSTRAINT "user_saved_presets_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



CREATE POLICY "Admins can insert audit logs" ON "public"."admin_audit_logs" FOR INSERT WITH CHECK (((( SELECT "user_profiles"."role"
   FROM "public"."user_profiles"
  WHERE ("user_profiles"."user_id" = "auth"."uid"())) = 'admin'::"public"."user_role") OR (( SELECT "user_profiles"."role"
   FROM "public"."user_profiles"
  WHERE ("user_profiles"."user_id" = "auth"."uid"())) = 'moderator'::"public"."user_role")));



CREATE POLICY "Admins can manage feature flags" ON "public"."feature_flags" USING ((( SELECT "user_profiles"."role"
   FROM "public"."user_profiles"
  WHERE ("user_profiles"."user_id" = "auth"."uid"())) = 'admin'::"public"."user_role"));



CREATE POLICY "Admins can manage hardware blacklist" ON "public"."hardware_blacklist" USING ((( SELECT "user_profiles"."role"
   FROM "public"."user_profiles"
  WHERE ("user_profiles"."user_id" = "auth"."uid"())) = 'admin'::"public"."user_role"));



CREATE POLICY "Admins can read all stats" ON "public"."user_lifetime_stats" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."user_profiles"
  WHERE (("user_profiles"."user_id" = "auth"."uid"()) AND ("user_profiles"."role" = 'admin'::"public"."user_role")))));



CREATE POLICY "Admins can update app settings" ON "public"."sk8lytz_app_settings" USING ((( SELECT "user_profiles"."role"
   FROM "public"."user_profiles"
  WHERE ("user_profiles"."user_id" = "auth"."uid"())) = 'admin'::"public"."user_role")) WITH CHECK ((( SELECT "user_profiles"."role"
   FROM "public"."user_profiles"
  WHERE ("user_profiles"."user_id" = "auth"."uid"())) = 'admin'::"public"."user_role"));



CREATE POLICY "Admins can view audit logs" ON "public"."admin_audit_logs" FOR SELECT USING ((( SELECT "user_profiles"."role"
   FROM "public"."user_profiles"
  WHERE ("user_profiles"."user_id" = "auth"."uid"())) = 'admin'::"public"."user_role"));



CREATE POLICY "Admins can view hardware blacklist" ON "public"."hardware_blacklist" FOR SELECT USING ((( SELECT "user_profiles"."role"
   FROM "public"."user_profiles"
  WHERE ("user_profiles"."user_id" = "auth"."uid"())) = 'admin'::"public"."user_role"));



CREATE POLICY "Allow anon to insert daemon status" ON "public"."daemon_status" FOR INSERT TO "anon" WITH CHECK (("id" = '00000000-0000-0000-0000-000000000000'::"uuid"));



CREATE POLICY "Allow anon to update daemon status" ON "public"."daemon_status" FOR UPDATE TO "anon" USING (("id" = '00000000-0000-0000-0000-000000000000'::"uuid")) WITH CHECK (("id" = '00000000-0000-0000-0000-000000000000'::"uuid"));



CREATE POLICY "Allow authenticated read and insert" ON "public"."inventory_adjustments_log" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "Allow authenticated users to read shopify webhook logs" ON "public"."shopify_webhook_logs" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Allow public inserts to telemetry" ON "public"."discovered_devices_telemetry" FOR INSERT WITH CHECK (true);



CREATE POLICY "Allow public inserts to tipz" ON "public"."tipz" FOR INSERT WITH CHECK (true);



CREATE POLICY "Allow public read access to daemon_status" ON "public"."daemon_status" FOR SELECT USING (true);



CREATE POLICY "Allow public reads of tipz" ON "public"."tipz" FOR SELECT USING (true);



CREATE POLICY "Anyone can insert logs" ON "public"."remote_debug_logs" FOR INSERT WITH CHECK (true);



CREATE POLICY "Anyone can read product catalog" ON "public"."product_catalog" FOR SELECT USING (("is_active" = true));



CREATE POLICY "Anyone can select custom_builder_presets" ON "public"."custom_builder_presets" FOR SELECT USING (true);



CREATE POLICY "Anyone can view app settings" ON "public"."sk8lytz_app_settings" FOR SELECT USING (("auth"."role"() = 'authenticated'::"text"));
...
CREATE POLICY "Anyone can view skate spots" ON "public"."skate_spots" FOR SELECT USING (true);



CREATE POLICY "Authenticated users can insert spots" ON "public"."skate_spots" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Authenticated users can update spots" ON "public"."skate_spots" FOR UPDATE TO "authenticated" USING (true);



CREATE POLICY "Authenticated users can upsert products" ON "public"."product_catalog" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "Enable delete for all users" ON "public"."inventory_snapshots" FOR DELETE USING (true);
...
CREATE POLICY "Enable insert for all users" ON "public"."inventory_snapshots" FOR INSERT WITH CHECK (true);
...
CREATE POLICY "Enable insert for authenticated users" ON "public"."telemetry_snapshots" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Enable insert for authenticated users and anon" ON "public"."telemetry_snapshots" FOR INSERT TO "authenticated", "anon" WITH CHECK (true);



CREATE POLICY "Enable read access for all users" ON "public"."inventory_snapshots" FOR SELECT USING (true);
...
CREATE POLICY "Leaders can update own session" ON "public"."crew_sessions" FOR UPDATE TO "authenticated" USING (("leader_user_id" = ( SELECT "auth"."uid"() AS "uid"))) WITH CHECK (("leader_user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "Only admins can select telemetry" ON "public"."discovered_devices_telemetry" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."user_profiles"
  WHERE (("user_profiles"."user_id" = "auth"."uid"()) AND (("user_profiles"."role" = 'admin'::"public"."user_role") OR ("user_profiles"."role" = 'moderator'::"public"."user_role"))))));



CREATE POLICY "Public scenes are widely viewable" ON "public"."shared_scenes" FOR SELECT USING (("is_public" = true));



CREATE POLICY "Service role reads all diagnostics" ON "public"."led_diagnostics" FOR SELECT USING (("auth"."role"() = 'service_role'::"text"));



CREATE POLICY "Skate spots are viewable by everyone." ON "public"."skate_spots" FOR SELECT USING (true);



CREATE POLICY "Users can create scenes" ON "public"."shared_scenes" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "author_id"));



CREATE POLICY "Users can delete own scenes" ON "public"."shared_scenes" FOR DELETE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "author_id"));



CREATE POLICY "Users can delete their own presets" ON "public"."user_saved_presets" FOR DELETE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can insert own diagnostics" ON "public"."led_diagnostics" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can insert their own presets" ON "public"."user_saved_presets" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can manage own skate sessions" ON "public"."skate_sessions" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can manage their own builder presets" ON "public"."custom_builder_presets" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Users can manage their own device group memberships" ON "public"."device_group_members" USING ((EXISTS ( SELECT 1
   FROM "public"."registered_devices" "rd"
  WHERE (("rd"."id" = "device_group_members"."device_id") AND ("rd"."user_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."registered_devices" "rd"
  WHERE (("rd"."id" = "device_group_members"."device_id") AND ("rd"."user_id" = "auth"."uid"())))));



CREATE POLICY "Users can manage their own registered devices" ON "public"."registered_devices" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Users can manage their own registered groups" ON "public"."registered_groups" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Users can read own diagnostics" ON "public"."led_diagnostics" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can read their own stats" ON "public"."user_lifetime_stats" FOR SELECT USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can select their own presets" ON "public"."user_saved_presets" FOR SELECT USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can update own scenes" ON "public"."shared_scenes" FOR UPDATE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "author_id")) WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "author_id"));



CREATE POLICY "Users can update their own presets" ON "public"."user_saved_presets" FOR UPDATE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can view own private scenes" ON "public"."shared_scenes" FOR SELECT TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "author_id"));



CREATE POLICY "Users manage own diagnostics" ON "public"."led_diagnostics" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id")) WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "allow_all_insert_telemetry_errors" ON "public"."telemetry_errors" FOR INSERT WITH CHECK (true);
...
CREATE POLICY "auth_insert_sop_archives" ON "public"."sop_archives" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "auth_select_sop_archives" ON "public"."sop_archives" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "authenticated_full_access" ON "public"."app_settings" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."cyclez" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."full_landed_costs" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."inventory_consumption" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."pack_ship_sops" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."print_queue" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."product_recipes" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."production_sops" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."projectz" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."raw_orders" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."raw_parcel_items" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."raw_parcel_summary" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."sales_ledger" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."socialz_audience" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."storefront_aliases" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."tagz" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."task_activity" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."task_comments" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."task_dependencies" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."task_templates" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."taskz" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."team_members" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."teams" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."template_subtasks" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."tipz" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "authenticated_full_access" ON "public"."work_orders" TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "crew_members_delete" ON "public"."crew_members" FOR DELETE TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "crew_members_insert" ON "public"."crew_members" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "crew_sessions_insert" ON "public"."crew_sessions" FOR INSERT TO "authenticated" WITH CHECK (("leader_user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "crew_sessions_select" ON "public"."crew_sessions" FOR SELECT USING ((("is_public" = true) OR ("leader_user_id" = ( SELECT "auth"."uid"() AS "uid")) OR ("id" IN ( SELECT "crew_members"."session_id"
...
CREATE POLICY "crews_delete" ON "public"."crews" FOR DELETE TO "authenticated" USING ((("owner_id" = ( SELECT "auth"."uid"() AS "uid")) OR (EXISTS ( SELECT 1
   FROM "public"."crew_memberships" "cm"
  WHERE (("cm"."crew_id" = "crews"."id") AND ("cm"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("cm"."role" = 'owner'::"text"))))));



CREATE POLICY "crews_insert" ON "public"."crews" FOR INSERT TO "authenticated" WITH CHECK (("owner_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "crews_update" ON "public"."crews" FOR UPDATE TO "authenticated" USING ((("owner_id" = ( SELECT "auth"."uid"() AS "uid")) OR (EXISTS ( SELECT 1
   FROM "public"."crew_memberships" "cm"
  WHERE (("cm"."crew_id" = "crews"."id") AND ("cm"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("cm"."role" = 'owner'::"text"))))));
...
CREATE POLICY "devices_owner_delete" ON "public"."registered_devices" FOR DELETE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "devices_owner_insert" ON "public"."registered_devices" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "devices_owner_select" ON "public"."registered_devices" FOR SELECT TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "devices_owner_update" ON "public"."registered_devices" FOR UPDATE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "groups_owner_delete" ON "public"."registered_groups" FOR DELETE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "groups_owner_insert" ON "public"."registered_groups" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "groups_owner_select" ON "public"."registered_groups" FOR SELECT TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "groups_owner_update" ON "public"."registered_groups" FOR UPDATE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "labelz_authenticated_only" ON "public"."label_designs" TO "authenticated" USING (true) WITH CHECK (true);



ALTER TABLE "public"."led_diagnostics" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "memberships_delete" ON "public"."crew_memberships" FOR DELETE TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "memberships_insert" ON "public"."crew_memberships" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "memberships_select" ON "public"."crew_memberships" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "picks_public_read" ON "public"."sk8lytz_picks" FOR SELECT USING (true);
...
CREATE POLICY "profiles_insert_secure" ON "public"."user_profiles" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "profiles_select_secure" ON "public"."user_profiles" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "profiles_update_secure" ON "public"."user_profiles" FOR UPDATE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "push_tokens_delete" ON "public"."push_tokens" FOR DELETE TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "push_tokens_insert" ON "public"."push_tokens" FOR INSERT TO "authenticated" WITH CHECK (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "push_tokens_select" ON "public"."push_tokens" FOR SELECT TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "push_tokens_update" ON "public"."push_tokens" FOR UPDATE TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "skate_sessions_owner_access" ON "public"."skate_sessions" TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
ALTER TABLE "public"."sop_archives" ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "telemetry_insert_auth" ON "public"."parsed_session_stats" FOR INSERT TO "authenticated" WITH CHECK (true);
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."cyclez";
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."full_landed_costs";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."hardware_blacklist";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."inventory_adjustments_log";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."inventory_consumption";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."label_designs";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."label_templates";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."pack_ship_sops";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."print_queue";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."product_catalog";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."product_recipes";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."production_sops";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."projectz";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."sales_ledger";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."shopify_webhook_logs";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."socialz_audience";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."storefront_aliases";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."tagz";
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."taskz";
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."template_subtasks";
...
GRANT ALL ON FUNCTION "public"."admin_add_hardware_blacklist"("p_mac_address" "text", "p_reason" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_add_hardware_blacklist"("p_mac_address" "text", "p_reason" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."admin_ban_user"("p_target_user_id" "uuid", "p_reason" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_ban_user"("p_target_user_id" "uuid", "p_reason" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."admin_export_user_data"("p_target_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_export_user_data"("p_target_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."admin_force_password_reset"("p_target_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_force_password_reset"("p_target_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."admin_get_global_telemetry"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_get_global_telemetry"() TO "service_role";



GRANT ALL ON FUNCTION "public"."admin_remove_hardware_blacklist"("p_mac_address" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_remove_hardware_blacklist"("p_mac_address" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."admin_revoke_admin_role"("p_target_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."admin_revoke_admin_role"("p_target_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_revoke_admin_role"("p_target_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."admin_revoke_ban"("p_target_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_revoke_ban"("p_target_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."admin_revoke_sessions"("p_target_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_revoke_sessions"("p_target_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."admin_soft_delete_user"("p_target_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."admin_soft_delete_user"("p_target_user_id" "uuid") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."delete_group_cascade"("p_group_id" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."delete_group_cascade"("p_group_id" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."delete_group_cascade"("p_group_id" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."flush_telemetry"("payload" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."flush_telemetry"("payload" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."flush_telemetry"("payload" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_active_schema_tables"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_active_schema_tables"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_active_schema_tables"() TO "service_role";



GRANT ALL ON FUNCTION "public"."get_closest_skate_spot"("p_lat" double precision, "p_lng" double precision, "p_radius_meters" double precision) TO "anon";
GRANT ALL ON FUNCTION "public"."get_closest_skate_spot"("p_lat" double precision, "p_lng" double precision, "p_radius_meters" double precision) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_closest_skate_spot"("p_lat" double precision, "p_lng" double precision, "p_radius_meters" double precision) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_databank_coverage"() TO "anon";
GRANT ALL ON FUNCTION "public"."get_databank_coverage"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_databank_coverage"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_nearby_push_tokens"("p_session_id" "uuid", "p_max_tokens" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_nearby_push_tokens"("p_session_id" "uuid", "p_max_tokens" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_nearby_push_tokens"("p_session_id" "uuid", "p_max_tokens" integer) TO "service_role";



GRANT ALL ON TABLE "public"."skate_spots" TO "anon";
GRANT ALL ON TABLE "public"."skate_spots" TO "authenticated";
GRANT ALL ON TABLE "public"."skate_spots" TO "service_role";



GRANT ALL ON FUNCTION "public"."get_next_spot_for_indexer"("priority_states" "text"[]) TO "anon";
GRANT ALL ON FUNCTION "public"."get_next_spot_for_indexer"("priority_states" "text"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_next_spot_for_indexer"("priority_states" "text"[]) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_next_spot_for_operator"("priority_states" "text"[]) TO "anon";
GRANT ALL ON FUNCTION "public"."get_next_spot_for_operator"("priority_states" "text"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_next_spot_for_operator"("priority_states" "text"[]) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."handle_auto_promotion"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."handle_auto_promotion"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."increment_scene_download"("scene_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."increment_scene_download"("scene_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."increment_scene_download"("scene_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."increment_scene_upvote"("scene_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."increment_scene_upvote"("scene_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."increment_scene_upvote"("scene_id" "uuid") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."upsert_group_with_devices"("p_group_id" "text", "p_group_name" "text", "p_type" "text", "p_device_ids" "text"[]) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."upsert_group_with_devices"("p_group_id" "text", "p_group_name" "text", "p_type" "text", "p_device_ids" "text"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."upsert_group_with_devices"("p_group_id" "text", "p_group_name" "text", "p_type" "text", "p_device_ids" "text"[]) TO "service_role";
...
GRANT ALL ON TABLE "public"."crew_memberships" TO "anon";
GRANT ALL ON TABLE "public"."crew_memberships" TO "authenticated";
GRANT ALL ON TABLE "public"."crew_memberships" TO "service_role";
...
GRANT ALL ON TABLE "public"."custom_builder_presets" TO "anon";
GRANT ALL ON TABLE "public"."custom_builder_presets" TO "authenticated";
GRANT ALL ON TABLE "public"."custom_builder_presets" TO "service_role";



GRANT ALL ON TABLE "public"."cyclez" TO "anon";
GRANT ALL ON TABLE "public"."cyclez" TO "authenticated";
GRANT ALL ON TABLE "public"."cyclez" TO "service_role";



GRANT ALL ON TABLE "public"."daemon_status" TO "anon";
GRANT ALL ON TABLE "public"."daemon_status" TO "authenticated";
GRANT ALL ON TABLE "public"."daemon_status" TO "service_role";



GRANT ALL ON TABLE "public"."device_group_members" TO "anon";
GRANT ALL ON TABLE "public"."device_group_members" TO "authenticated";
GRANT ALL ON TABLE "public"."device_group_members" TO "service_role";



GRANT ALL ON TABLE "public"."discovered_devices_telemetry" TO "anon";
GRANT ALL ON TABLE "public"."discovered_devices_telemetry" TO "authenticated";
GRANT ALL ON TABLE "public"."discovered_devices_telemetry" TO "service_role";
...
GRANT ALL ON TABLE "public"."full_landed_costs" TO "anon";
GRANT ALL ON TABLE "public"."full_landed_costs" TO "authenticated";
GRANT ALL ON TABLE "public"."full_landed_costs" TO "service_role";



GRANT ALL ON SEQUENCE "public"."full_landed_costs_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."full_landed_costs_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."full_landed_costs_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."hardware_blacklist" TO "anon";
GRANT ALL ON TABLE "public"."hardware_blacklist" TO "authenticated";
GRANT ALL ON TABLE "public"."hardware_blacklist" TO "service_role";



GRANT ALL ON TABLE "public"."inventory_adjustments_log" TO "anon";
GRANT ALL ON TABLE "public"."inventory_adjustments_log" TO "authenticated";
GRANT ALL ON TABLE "public"."inventory_adjustments_log" TO "service_role";



GRANT ALL ON TABLE "public"."inventory_consumption" TO "anon";
GRANT ALL ON TABLE "public"."inventory_consumption" TO "authenticated";
...
GRANT ALL ON TABLE "public"."label_designs" TO "anon";
GRANT ALL ON TABLE "public"."label_designs" TO "authenticated";
GRANT ALL ON TABLE "public"."label_designs" TO "service_role";
...
GRANT ALL ON TABLE "public"."led_diagnostics" TO "anon";
GRANT ALL ON TABLE "public"."led_diagnostics" TO "authenticated";
GRANT ALL ON TABLE "public"."led_diagnostics" TO "service_role";



GRANT ALL ON TABLE "public"."pack_ship_sops" TO "anon";
GRANT ALL ON TABLE "public"."pack_ship_sops" TO "authenticated";
GRANT ALL ON TABLE "public"."pack_ship_sops" TO "service_role";



GRANT ALL ON TABLE "public"."parsed_session_stats" TO "anon";
GRANT ALL ON TABLE "public"."parsed_session_stats" TO "authenticated";
GRANT ALL ON TABLE "public"."parsed_session_stats" TO "service_role";
...
GRANT ALL ON TABLE "public"."production_sops" TO "anon";
GRANT ALL ON TABLE "public"."production_sops" TO "authenticated";
GRANT ALL ON TABLE "public"."production_sops" TO "service_role";



GRANT ALL ON TABLE "public"."projectz" TO "anon";
GRANT ALL ON TABLE "public"."projectz" TO "authenticated";
GRANT ALL ON TABLE "public"."projectz" TO "service_role";
...
GRANT ALL ON TABLE "public"."raw_orders" TO "anon";
GRANT ALL ON TABLE "public"."raw_orders" TO "authenticated";
GRANT ALL ON TABLE "public"."raw_orders" TO "service_role";



GRANT ALL ON TABLE "public"."raw_parcel_items" TO "anon";
GRANT ALL ON TABLE "public"."raw_parcel_items" TO "authenticated";
GRANT ALL ON TABLE "public"."raw_parcel_items" TO "service_role";



GRANT ALL ON SEQUENCE "public"."raw_parcel_items_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."raw_parcel_items_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."raw_parcel_items_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."raw_parcel_summary" TO "anon";
GRANT ALL ON TABLE "public"."raw_parcel_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."raw_parcel_summary" TO "service_role";
...
GRANT ALL ON TABLE "public"."registered_groups" TO "anon";
GRANT ALL ON TABLE "public"."registered_groups" TO "authenticated";
GRANT ALL ON TABLE "public"."registered_groups" TO "service_role";
...
GRANT ALL ON TABLE "public"."sales_ledger" TO "anon";
GRANT ALL ON TABLE "public"."sales_ledger" TO "authenticated";
GRANT ALL ON TABLE "public"."sales_ledger" TO "service_role";



GRANT ALL ON TABLE "public"."shared_scenes" TO "anon";
GRANT ALL ON TABLE "public"."shared_scenes" TO "authenticated";
GRANT ALL ON TABLE "public"."shared_scenes" TO "service_role";



GRANT ALL ON TABLE "public"."shopify_webhook_logs" TO "anon";
GRANT ALL ON TABLE "public"."shopify_webhook_logs" TO "authenticated";
GRANT ALL ON TABLE "public"."shopify_webhook_logs" TO "service_role";



GRANT ALL ON TABLE "public"."sk8lytz_app_settings" TO "anon";
GRANT ALL ON TABLE "public"."sk8lytz_app_settings" TO "authenticated";
GRANT ALL ON TABLE "public"."sk8lytz_app_settings" TO "service_role";



GRANT ALL ON TABLE "public"."sk8lytz_picks" TO "anon";
GRANT ALL ON TABLE "public"."sk8lytz_picks" TO "authenticated";
GRANT ALL ON TABLE "public"."sk8lytz_picks" TO "service_role";



GRANT ALL ON TABLE "public"."skate_sessions" TO "anon";
GRANT ALL ON TABLE "public"."skate_sessions" TO "authenticated";
GRANT ALL ON TABLE "public"."skate_sessions" TO "service_role";



GRANT ALL ON TABLE "public"."socialz_audience" TO "anon";
GRANT ALL ON TABLE "public"."socialz_audience" TO "authenticated";
GRANT ALL ON TABLE "public"."socialz_audience" TO "service_role";



GRANT ALL ON TABLE "public"."sop_archives" TO "anon";
GRANT ALL ON TABLE "public"."sop_archives" TO "authenticated";
GRANT ALL ON TABLE "public"."sop_archives" TO "service_role";



GRANT ALL ON TABLE "public"."storefront_aliases" TO "anon";
GRANT ALL ON TABLE "public"."storefront_aliases" TO "authenticated";
GRANT ALL ON TABLE "public"."storefront_aliases" TO "service_role";



GRANT ALL ON TABLE "public"."tagz" TO "anon";
GRANT ALL ON TABLE "public"."tagz" TO "authenticated";
GRANT ALL ON TABLE "public"."tagz" TO "service_role";
...
GRANT ALL ON TABLE "public"."taskz" TO "anon";
GRANT ALL ON TABLE "public"."taskz" TO "authenticated";
GRANT ALL ON TABLE "public"."taskz" TO "service_role";
...
GRANT ALL ON TABLE "public"."telemetry_errors" TO "anon";
GRANT ALL ON TABLE "public"."telemetry_errors" TO "authenticated";
GRANT ALL ON TABLE "public"."telemetry_errors" TO "service_role";



GRANT ALL ON TABLE "public"."telemetry_snapshots" TO "anon";
GRANT ALL ON TABLE "public"."telemetry_snapshots" TO "authenticated";
GRANT ALL ON TABLE "public"."telemetry_snapshots" TO "service_role";



GRANT ALL ON TABLE "public"."template_subtasks" TO "anon";
GRANT ALL ON TABLE "public"."template_subtasks" TO "authenticated";
GRANT ALL ON TABLE "public"."template_subtasks" TO "service_role";



GRANT ALL ON TABLE "public"."tipz" TO "anon";
GRANT ALL ON TABLE "public"."tipz" TO "authenticated";
GRANT ALL ON TABLE "public"."tipz" TO "service_role";



GRANT ALL ON SEQUENCE "public"."tipz_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."tipz_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."tipz_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."user_lifetime_stats" TO "anon";
GRANT ALL ON TABLE "public"."user_lifetime_stats" TO "authenticated";
GRANT ALL ON TABLE "public"."user_lifetime_stats" TO "service_role";



GRANT ALL ON TABLE "public"."user_saved_presets" TO "anon";
GRANT ALL ON TABLE "public"."user_saved_presets" TO "authenticated";
GRANT ALL ON TABLE "public"."user_saved_presets" TO "service_role";
