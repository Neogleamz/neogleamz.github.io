...
description: "Triggers whenever the user wants to dispatch a swarm or subagent via [/teamwork-preview]. Enforces the Swarm Lock Ledger Protocol before dispatch."
