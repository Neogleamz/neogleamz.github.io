...
2. **The First-Principles Audit**: Before proposing a theory or writing a fix, you MUST natively open and read `.agents/workflows/master_reference.md`. This is the Canonical Source of Truth. If the answer is not there, you MUST read the live execution logic in the `src/` codebase.
