...
1. **Read the Compass**: Silently parse the `.agents/workflows/master_reference.md` file (specifically Section 1: "Product Bible") to load the Core Philosophies and Anti-Goals into your active memory.
