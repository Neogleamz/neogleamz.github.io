...
1. **Strict Read-Only**: You are strictly forbidden from writing new feature code, modifying `.agents/workflows/bucket_list.md`, or attempting to write a "quick fix" patch.
