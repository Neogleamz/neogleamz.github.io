...
4. **Knowledge Audit Gate (NEW)**: Before merging, evaluate if the overarching feature branch established new critical knowledge (DB tables, Bluetooth commands, global contexts). If yes, ensure it is documented in `.agents/workflows/master_reference.md`.
4. **Merge Routine**:
