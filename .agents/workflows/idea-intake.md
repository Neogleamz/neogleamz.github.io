...
4. **Determine Placement**: Read `.agents/workflows/bucket_list.md` to see the current active epics and categories.
...
5. **Update File**: Use your code-editing tools to insert the newly formatted item into the correct section of `.agents/workflows/bucket_list.md`.
