...
- **Precision Mapping:** You must explicitly name the correct Hub tab (e.g., `STOCKZ`, `EDITZ`, `SOCIALZ`) and the specific page elements, modals, or buttons they need to click to verify your work in the live browser.
