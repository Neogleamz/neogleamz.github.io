...
function renderFgiTable() {
    ...
    let a = Object.keys(productsDB).map(p => { 
        ...
        return { k: k, n: p, b: b, pb: pb, sold: sold, s: s, ms: ms, tc: breakdown.total, msrpv: msrpv, tv: tv, isSub: !!isSubassemblyDB[p], is3D: is3D }; 
    });
