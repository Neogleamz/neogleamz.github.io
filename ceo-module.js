...
function initCeoCharts() {
    ...
    ceoExpenseChart = new Chart(document.getElementById('expenseChart'), {
        ...
        data: { labels: ['COGS', 'Market', 'Affil', 'Labor', 'Warr', 'Logis', 'Fees', 'Net'], datasets: [{ data: [0,0,0,0,0,0,0,0], backgroundColor: ['#333', '#ff0033', '#ffcc00', '#b000ff', '#ff9900', '#00e5ff', '#aaaaaa', '#00ff66'], borderRadius: 4 }] },
    ...
    ceoProfitChart = new Chart(document.getElementById('profitChart'), { type: 'doughnut', data: { labels: [], datasets: [{ data: [], backgroundColor: ['#00ff66', '#00e5ff', '#b000ff', '#ffcc00', '#ff0033', '#ffffff'], borderWidth: 0 }] }, options: { responsive: true, maintainAspectRatio: false, cutout: '65%', plugins: { legend: { position: 'right' } } } });
