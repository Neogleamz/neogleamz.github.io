...
async function run() {
  console.log("Fixing remaining misplaced UUIDs...");
  ...
  const tables = [
    { name: 'pack_ship_sops', pk: 'id', uuidCol: 'recipe_item_uuid' },
    { name: 'production_sops', pk: 'product_item_uuid', uuidCol: 'product_item_uuid' },
    { name: 'work_orders', pk: 'wo_id', uuidCol: 'product_item_uuid' }
  ];
