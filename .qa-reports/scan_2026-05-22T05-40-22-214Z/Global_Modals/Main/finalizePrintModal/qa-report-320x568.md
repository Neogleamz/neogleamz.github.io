...
- **Usability**: Tap target too small on `<input id="finalizePrintName" class="">` (270.1499938964844x31.200000762939453). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="finalizePrintSuccess" class="">` (127.57500457763672x36). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="finalizePrintFailed" class="">` (127.57500457763672x36). Recommended 44x44px.
