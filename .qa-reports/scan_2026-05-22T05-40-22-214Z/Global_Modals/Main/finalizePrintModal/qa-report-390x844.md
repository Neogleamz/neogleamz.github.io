...
- **Usability**: Tap target too small on `<input id="finalizePrintName" class="">` (319.1125183105469x31.200000762939453). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="finalizePrintSuccess" class="">` (152.0500030517578x36). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="finalizePrintFailed" class="">` (152.0625x36). Recommended 44x44px.
