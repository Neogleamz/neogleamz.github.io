### Hub: Global_Modals | Page: Main | Modal: finalizePrintModal
...
- **Usability**: Tap target too small on `<input id="finalizePrintName" class="">` (358.3999938964844x31.200000762939453). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="finalizePrintSuccess" class="">` (171.6999969482422x36). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="finalizePrintFailed" class="">` (171.6999969482422x36). Recommended 44x44px.
...
- **Usability**: Tap target too small on `<button id="" class="btn-green">` (252.58750915527344x34.400001525878906). Recommended 44x44px.
