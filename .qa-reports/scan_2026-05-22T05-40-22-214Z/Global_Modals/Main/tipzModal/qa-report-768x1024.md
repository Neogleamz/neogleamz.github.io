### Hub: Global_Modals | Page: Main | Modal: tipzModal
...
- **Usability**: Tap target too small on `<button id="" class="btn-green">` (134.0500030517578x32.79999923706055). Recommended 44x44px.
- **Usability**: Tap target too small on `<button id="" class="btn-red">` (79.8375015258789x30.399999618530273). Recommended 44x44px.
- **Usability**: Tap target too small on `<button id="newTipPrioHigh" class="">` (38.60000228881836x16.80000114440918). Recommended 44x44px.
- **Usability**: Tap target too small on `<button id="newTipPrioMed" class="">` (35.82500076293945x16.80000114440918). Recommended 44x44px.
- **Usability**: Tap target too small on `<button id="newTipPrioLow" class="">` (36.9375x16.80000114440918). Recommended 44x44px.
- **Usability**: Tap target too small on `<button id="" class="btn-blue">` (86.82500457763672x22.399999618530273). Recommended 44x44px.
