### Hub: Global_Modals | Page: Main | Modal: paperProfileModal
...
- **Usability**: Tap target too small on `<input id="newPaperName" class="">` (71.95000457763672x31.200000762939453). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="newPaperW" class="">` (35.97500228881836x31.200000762939453). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="newPaperH" class="">` (35.97500228881836x31.200000762939453). Recommended 44x44px.
