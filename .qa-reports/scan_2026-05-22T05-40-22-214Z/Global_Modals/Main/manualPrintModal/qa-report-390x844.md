...
- **Usability**: Tap target too small on `<input id="manualPrintQty" class="">` (368x39.20000076293945). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="manualPrintLabel" class="">` (368x36.400001525878906). Recommended 44x44px.
