...
- **Usability**: Tap target too small on `<button id="" class="btn-red">` (460.8000183105469x30.399999618530273). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="manualPrintQty" class="">` (478.3999938964844x39.20000076293945). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="manualPrintLabel" class="">` (478.3999938964844x36.400001525878906). Recommended 44x44px.
