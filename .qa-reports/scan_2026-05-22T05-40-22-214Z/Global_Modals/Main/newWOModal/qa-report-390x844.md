...
- **Usability**: Tap target too small on `<input id="newWOQty" class="">` (83.5250015258789x40). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="newWOLabel" class="">` (364.75x36.400001525878906). Recommended 44x44px.
