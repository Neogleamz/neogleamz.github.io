### Hub: Global_Modals | Page: Main | Modal: actual-net-modal
...
- **Usability**: Tap target too small on `<input id="actualNetSearch" class="">` (120.92500305175781x32). Recommended 44x44px.
- **Usability**: Tap target too small on `<button id="" class="btn-red">` (125.7125015258789x34.400001525878906). Recommended 44x44px.
- **Layout Density**: `<div class="table-wrap">` has excessive wasted space (Density: 2.3%). Consider flexing children or adjusting width.
