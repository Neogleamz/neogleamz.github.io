...
- **Usability**: Tap target too small on `<input id="actualNetSearch" class="">` (98.1875x32). Recommended 44x44px.
- **Layout Density**: `<div class="table-wrap">` has excessive wasted space (Density: 2.7%). Consider flexing children or adjusting width.
