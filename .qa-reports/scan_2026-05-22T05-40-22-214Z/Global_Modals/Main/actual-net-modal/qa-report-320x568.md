...
- **Usability**: Tap target too small on `<input id="actualNetSearch" class="">` (50.75x32). Recommended 44x44px.
- **Layout Density**: `<div class="table-wrap">` has excessive wasted space (Density: 4.5%). Consider flexing children or adjusting width.
