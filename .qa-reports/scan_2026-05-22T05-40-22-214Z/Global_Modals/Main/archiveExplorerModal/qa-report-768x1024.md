### Hub: Global_Modals | Page: Main | Modal: archiveExplorerModal
...
- **Usability**: Tap target too small on `<button id="" class="modal-close-btn">` (96.7249984741211x32). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="archiveSearchInput" class="">` (514.4375x32.79999923706055). Recommended 44x44px.
- **Usability**: Tap target too small on `<button id="" class="btn-red">` (149.6374969482422x33.60000228881836). Recommended 44x44px.
