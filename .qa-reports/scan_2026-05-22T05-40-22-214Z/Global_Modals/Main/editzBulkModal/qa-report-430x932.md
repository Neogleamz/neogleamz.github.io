...
- **Usability**: Tap target too small on `<input id="editzBulkFind" class="">` (48.72500228881836x27.200000762939453). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="editzBulkReplace" class="">` (48.73749923706055x27.200000762939453). Recommended 44x44px.
