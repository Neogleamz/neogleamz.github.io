### Hub: Global_Modals | Page: Main | Modal: sopViewerModal
...
- **Usability**: Tap target too small on `<button id="" class="btn-ghost-base btn-ghost-blue">` (136.7375030517578x40). Recommended 44x44px.
- **Usability**: Tap target too small on `<button id="btnPackerzLiveToggleEdit" class="btn-blue">` (348.63751220703125x40.79999923706055). Recommended 44x44px.
- **Usability**: Tap target too small on `<button id="" class="btn-red">` (89.8375015258789x38.400001525878906). Recommended 44x44px.
- **Layout Density**: `<div class="">` has excessive wasted space (Density: 1.7%). Consider flexing children or adjusting width.
- **Layout Density**: `<div class="">` has excessive wasted space (Density: 0.0%). Consider flexing children or adjusting width.
