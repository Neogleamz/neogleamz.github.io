...
- **Usability**: Tap target too small on `<button id="" class="hover-green-subtle">` (146.6750030517578x43.20000076293945). Recommended 44x44px.
- **Usability**: Tap target too small on `<button id="btnRecipeManagerDiscard" class="btn-red-muted">` (359.1750183105469x40). Recommended 44x44px.
- **Usability**: Tap target too small on `<button id="btnRecipeManagerSync" class="btn-green-neon">` (364.625x40). Recommended 44x44px.
