...
- **Usability**: Tap target too small on `<button id="" class="btn-green-neon">` (78.1875x36.79999923706055). Recommended 44x44px.
- **Layout Density**: `<div class="">` has excessive wasted space (Density: 2.8%). Consider flexing children or adjusting width.
- **Usability**: Tap target too small on `<button id="" class="btn-red">` (91.9375x40.79999923706055). Recommended 44x44px.
- **Usability**: Tap target too small on `<button id="" class="btn-green">` (291.375x40.79999923706055). Recommended 44x44px.
