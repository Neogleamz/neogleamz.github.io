### Hub: Global_Modals | Page: Main | Modal: te-tag-manager-modal
...
- **Usability**: Tap target too small on `<input id="te-tag-mngr-color" class="">` (40x40). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="te-tag-mngr-name" class="">` (108.48750305175781x40). Recommended 44x44px.
