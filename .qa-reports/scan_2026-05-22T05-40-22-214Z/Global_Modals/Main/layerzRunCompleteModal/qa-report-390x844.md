...
- **Usability**: Tap target too small on `<input id="layerzRunPartName" class="">` (318.3999938964844x31.200000762939453). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="layerzRunSuccessQty" class="">` (151.6999969482422x36). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="layerzRunScrapQty" class="">` (151.6999969482422x36). Recommended 44x44px.
