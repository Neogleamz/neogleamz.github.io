...
- **Usability**: Tap target too small on `<input id="ccMngrSearch" class="">` (256.07501220703125x35.20000076293945). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="ccMngrQtyInput" class="">` (256.07501220703125x40). Recommended 44x44px.
