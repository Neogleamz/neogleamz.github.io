### Hub: Global_Modals | Page: Main | Modal: cycleCountManagerModal
...
- **Usability**: Tap target too small on `<input id="ccMngrSearch" class="">` (396.8000183105469x35.20000076293945). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="ccMngrQtyInput" class="">` (396.8000183105469x40). Recommended 44x44px.
