### Hub: Global_Modals | Page: Main | Modal: force-sync-modal
...
- **Layout Density**: `<div class="modal-overlay active">` has excessive wasted space (Density: 14.3%). Consider flexing children or adjusting width.
- **Usability**: Tap target too small on `<button id="" class="">` (232.71250915527344x43.20000076293945). Recommended 44x44px.
- **Usability**: Tap target too small on `<input id="forceSyncInput" class="">` (350.3999938964844x37.60000228881836). Recommended 44x44px.
- **Usability**: Tap target too small on `<button id="" class="">` (170.65000915527344x32). Recommended 44x44px.
- **Usability**: Tap target too small on `<button id="btnForceSyncSubmit" class="">` (169.75x32). Recommended 44x44px.
