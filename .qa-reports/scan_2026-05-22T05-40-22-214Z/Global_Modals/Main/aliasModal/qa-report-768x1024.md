...
- **Usability**: Tap target too small on `<button id="" class="btn-red">` (134.47500610351562x38.400001525878906). Recommended 44x44px.
- **Usability**: Tap target too small on `<button id="btnSaveAliasMapping" class="btn-green">` (185.02500915527344x38.400001525878906). Recommended 44x44px.
