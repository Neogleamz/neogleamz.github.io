...
function openBulkAddModal() {
    ...
    Object.keys(productsDB).sort().forEach(p => { if(p === currentProduct) return; bulkAddData.push({ k: `RECIPE:::${p}`, isSub: true, nn: isSubassemblyDB[p] ? "⚙️" : "📦", np: "Sub-Assembly", n: p, sp: "(Nested Recipe)", uc: getEngineTrueCogs(p), q: "" }); });
