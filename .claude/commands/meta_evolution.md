...
3. **The Self-Modification (Brain Surgery)**: 
   ...
   - Strictly adhering to the **Surgical Strike Protocol**, use your native `Edit` or `Write` tools to inject the new standard. Do NOT overwrite entire rule files from memory.
