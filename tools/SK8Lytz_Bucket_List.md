...
- [ ] debt/eslint-warnings-sweep : Resolve the 11 ESLint warnings (no-undef on updateLabelCanvasOrientation, showNexlPane, Image, and no-unused-vars) to achieve 100% warning-free lint output. [🤖 Antigravity] [🧠 4k / 5k] [💸 $0.02 / $0.02]
