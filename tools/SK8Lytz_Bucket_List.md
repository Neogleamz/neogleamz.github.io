...
---
- [x] `feat/infinite-nested-subtasks` : **Infinite Nested Subtasks** - Task Engine: Support infinite nested subtasks (n-level hierarchy) and drag-and-drop subtask repositioning. [🤖 Gemini 3.1 Pro (High)] [🧠 TBD / 5k] [💸 TBD / $0.02]
