...
- [ ] `bug/socialz-lastpass-error` : **Socialz Extension Error** - Investigate diagnostic console error "Cannot create item with duplicate id LastPass" when adding a skater to Socialz (likely a LastPass Chrome extension conflict). [🤖 Gemini 3.1 Pro (High)] [🧠 TBD / 5k] [💸 TBD / $0.02]
