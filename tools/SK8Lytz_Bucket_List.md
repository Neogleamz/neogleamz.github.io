...
- [x] `chore/orphan-script-cleanup` : **Relocate Orphan Root Scripts** - Move 6 loose utility scripts (check_openapi.js, check_schema.js, check_ids.js, test-fetchall.js, test-supabase.js, test.js) from the project root into `tools/` or `scripts/` directories. [🤖 AI Model] [🧠 8k / 3k] [💸 $0.03 / $0.01]
